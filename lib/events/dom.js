...
const onMouseDown = (evt: MouseEvent, meta?: DragEventMeta): void => {
  if (!meta) {
    return;
  }
...
const onMouseMove = (evt: MouseEvent, meta?: DragEventMeta): void => {
  if (!meta) {
    return;
  }
  if (!meta.dragging) {
...
const onMouseUp = (evt: MouseEvent, meta?: DragEventMeta): void => {
  if (!meta) {
    return;
  }
